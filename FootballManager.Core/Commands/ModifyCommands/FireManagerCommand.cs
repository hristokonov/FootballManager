...
{
    public class FireManagerCommand : ICommand
    {
        
        private IManagerService service;
        public FireManagerCommand(IManagerService service)
        {
        ...
        public string Execute(IReadOnlyList<string> args)
        {
            ...
            var manager = service.FireManager(firstName, lastName, name, city);
            return $"Team {name} {city} fired {manager.FirstName} {manager.LastName}";
        }
    }
}
